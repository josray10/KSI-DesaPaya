...
<body>
    <div class="container">
        ...
        <div class="slider-container">
            <div class="slider">
                <div class="slide"><img src="../image/berandadesa/Hero_image_desa_paya.png" alt="slide1"></div>
                <div class="slide"><img src="../image/berandadesa/sejarah.jpg" alt="slide2"></div>
                <div class="slide"><img src="../image/berandadesa/Hero_image_desa_paya.png" alt="slide3"></div>
        ...
        <fieldset class="boxartikel">
            ...
            if ($data->num_rows > 0) {
                while ($artikel = $data->fetch_assoc()) {
                    ?>
                    <a href="../user/lihatartikel.php?artikel=<?= $artikel['id'] ?>">
                        <div class="artikel">
